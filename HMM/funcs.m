classdef funcs < handle
    %This class has properties and methods, through which HMM is
    %implemented
    %All source code is written by me
    
    %HMM has properties as follows:
    properties
        nm = ''; %It stands for the name of the word
    ...
    methods
        ...
        function self = funcs(nm)
            self.nm = nm;
        end
        
        %Below function simply creates a Gaussian mixtures given observation
        %samples
        ...
        function beta = backw(self, samples, gauss)
            ...
            i = lim - 1;
            %It goes backward in the time direction
            while i >= 1
        ...
        function [likelihoodLog, alpha] = forw(self, samples, gauss)
            ...
            i = 1;
            %It goes forward in the time direction
            while i <= lim
                if i ~= 1
                ...
                %Likelihood is calculated below that determines how similar
                %two words are
        ...
        function process(self, samples)
            ...
            %Below some random observation samples are defined as mean
            %values of Gaussian mixtures
            while i < 100000000 %It could be Inf value as well
            ...
            %EM iteration number can be assigned any value one wants
            iterateNo = 10;
            ...
            for j = 1:1:iterateNo
                ...
                %to be used by Baum-Welch algorithm
                while w <= (lengthSam - 1)
                ...
                %Iteration occurs n times, where n denotes the state number
